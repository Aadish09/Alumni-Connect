...
// @desc    Create or update the profile logged in
// @access  Private
...
router.post(
  ...
  async (req, res) => {
    ...
    // create a blank array of profile fields and assign to req object values
    const {
      company,
      website,
      location,
...
// @desc    Delete profile with user_id
// @access  Public
...
// @desc    Get user repos from Gihub
// @access  Public
